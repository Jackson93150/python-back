"""
URL configuration for testSDV project.
...
from quickstart.views import (
    AuteurViewSet, LivreViewSet, CategorieViewSet, ExemplaireViewSet,
    EmpruntViewSet, CommentaireViewSet, EditeurViewSet, EvaluationViewSet, CustomTokenObtainPairView
)
...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="support@bibliotheque.com"),
